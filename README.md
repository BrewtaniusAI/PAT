...
- `--profile <code>` — Language profile code (`yo`, `sw`, `zu`) for profile-aware tokenization
...
|------|----------|-------------------|-----------------|
| `yo` | **Yorùbá** | `ẹ ọ ṣ á à é è í ì ó ò ú ù` | `ẹ, ọ, ṣ, ọba, àwọn, ilẹ` |
| `sw` | **Kiswahili** | — | `habari, asante, karibu, sawa, rafiki, afrika` |
| `zu` | **isiZulu** | — | `sawubona, ngiyabonga, umuntu, izwe, afrika` |
...
<p align="center"><em>Built by BrewtaniusAI · Part of CollectiveOS · Patent-free forever</em></p>
